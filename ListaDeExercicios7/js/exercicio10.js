function exer10() {
  ...
  if (entrada.length > 0) {
    ...
    let onclickAtributo = document.createAttribute("onclick");

    // Define o valor do atributo "onclick" como "exibir()"
    onclickAtributo.value = "exibir()";

    // Adiciona o atributo "onclick" ao <li>
    novoItem.setAttributeNode(onclickAtributo);
